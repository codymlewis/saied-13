...
main <- function() {
    ...
    attack_type = `if`(opt_get("service-set", n=0), SERVICE_SET_FLAG * BAD_MOUTH_FLAG, attack_type)
    attack_type = `if`(opt_get("capability-set", n=0), CAPABILITY_SET_FLAG * BAD_MOUTH_FLAG, attack_type)
    attack_type = `if`(opt_get("service-capability-set", n=0), SERVICE_SET_FLAG * CAPABILITY_SET_FLAG * BAD_MOUTH_FLAG, attack_type)
    attack_type = `if`(opt_get("time-decay", n=0), TIME_DECAY_FLAG * BAD_MOUTH_FLAG, attack_type)
    attack_type = `if`(opt_get("service-capability-set-time-decay", n=0), SERVICE_SET_FLAG * CAPABILITY_SET_FLAG * TIME_DECAY_FLAG * BAD_MOUTH_FLAG, attack_type)
    attack_type = `if`(opt_get("service-set-time-decay", n=0), SERVICE_SET_FLAG * TIME_DECAY_FLAG * BAD_MOUTH_FLAG, attack_type)
    attack_type = `if`(opt_get("capability-set-time-decay", n=0), CAPABILITY_SET_FLAG * TIME_DECAY_FLAG * BAD_MOUTH_FLAG, attack_type)
