...
# ./ConsoleInterface.r --bad_mouth --capability_set --transactions=500 --malicious_start=0.30 --malicious_end=0.30 --targeted --alt
./ConsoleInterface.r --bad_mouth --capability_set --transactions=500 --malicious_start=0.55 --malicious_end=0.55 --targeted --alt
./ConsoleInterface.r --bad_mouth --capability_set --transactions=500 --malicious_start=0.55 --malicious_end=0.55 --targeted --alt2
./ConsoleInterface.r --bad_mouth --capability_set --transactions=500 --malicious_start=0.30 --malicious_end=0.30 --targeted --alt
./ConsoleInterface.r --bad_mouth --capability_set --transactions=500 --malicious_start=0.30 --malicious_end=0.30 --targeted --alt2
# ./ConsoleInterface.r --bad_mouth --capability_set --transactions=500 --malicious_start=0.55 --malicious_end=0.55 && \
# ./ConsoleInterface.r --bad_mouth --capability_set --transactions=500 --malicious_start=0.55 --malicious_end=0.55 --targeted
# ./ConsoleInterface.r --bad_mouth --capability_set --transactions=500 --malicious_start=0.30 --malicious_end=0.30 --targeted --alt
# ./ConsoleInterface.r --bad_mouth --capability_set --transactions=500 --malicious_start=0.35 --malicious_end=0.35 --targeted --time_change=120
