...
./ConsoleInterface.r --good-mouth --service-capability-set-time-decay & \
...
./ConsoleInterface.r --on-off --service-capability-set & \
./ConsoleInterface.r --on-off --time-decay & \
./ConsoleInterface.r --on-off --service-capability-set-time-decay;
